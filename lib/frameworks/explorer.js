...
exports.run = function(runner) {
  ...
  return q.promise(function(resolve) {
    ...
    browser.executeScriptWithDescription_('var e = 0', 'starting explorer hook');  
    browser.enterRepl();
    browser.executeScriptWithDescription_('var e = 1', 'done with explorer hook').then(function() {
      resolve({
        failedCount: 0
      });
    });
